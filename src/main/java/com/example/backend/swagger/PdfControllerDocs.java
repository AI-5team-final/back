...
public interface PdfControllerDocs {
    ...
    @Operation(
            ...
            requestBody = @RequestBody(
                    ...
                    content = @Content(schema = @Schema(
                            ...
                            example = "{ \"resume_eval\": \"내용을 추가해 주세요.\", \"selfintro_eval\": \"적합\", \"resume_score\": 80.5, \"selfintro_score\": 75.0, \"selfIntroFeedback\": \"적절한 개선 필요\" }"
                    ))
            ),
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(schema = @Schema(implementation = AgentFeedbackDTO.class))
                    ),
                    @ApiResponse(
                            responseCode = "500",
    ...
    ResponseEntity<AgentFeedbackDTO> analyzeWithAgent(
